...
import autoDev.server.dto.ChatMessageResponse;
import autoDev.server.dto.ChatSessionResponse;
import autoDev.server.dto.CreateChatSessionRequest;
import autoDev.server.entity.*;
import autoDev.server.exceptions.BadRequestException;
import autoDev.server.exceptions.NotFoundException;
import autoDev.server.repository.ChatMessageRepository;
import autoDev.server.repository.ChatSessionRepository;
import autoDev.server.services.ai.ChatPromptBuilder;
import autoDev.server.services.ai.ChatStreamHandler;
import autoDev.server.services.ai.CitationMapper;
import autoDev.server.services.ai.CodeContextRetriever;
 ...
 * Each step is implemented in a dedicated class under {@code services.ai}.
 */
@Service
