...
import {AutodevIcon} from "@/components/icons/autodev-icon";
                    ...
                    <SidebarMenu>
                        <SidebarMenuItem>
                            <SidebarMenuButton
                                ...
                                tooltip="AutoDev"
                            >
                                <AutodevIcon className="size-8 rounded-[10px]"/>
                                <div className="grid flex-1 text-left text-sm leading-tight">
                                    <span className="truncate font-semibold">AutoDev</span>
...
export function BrandMark({className}: { className?: string }) {
    return (
        ...
        >
            <AutodevIcon className="size-8 rounded-[10px]"/>
            <span className="font-heading text-[1.05rem] leading-none">AutoDev</span>
        </div>
    );
}
